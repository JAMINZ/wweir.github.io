...
<link href="%root_path%css/index.css" rel="stylesheet">
<!--[if lt IE 9]>
...
<body>
<header>
  <h1><a href="%root_path%">wweir's blog</a></h1>
...
<div id="nav">
     ...
     <script src="%root_path%js/silder.js"></script><!--获取当前页导航 高亮显示标题-->
</div>
</div>
<div class="blank"></div>
<article>
...
<aside class="navsidebar">
   ...
   <div class="vcard">
      ...
      <p class="url">主页：<a href="http://weiki.tk" target="_blank">weiki.tk</a></p>
      <p class="address">现居：南京 江宁区</p>
      <p class="role">职业：学生</p>
    </div>   
   <!--<h2><p>博客分类</p></h2>
<ul class="news">
  <li><a href="%root_path%">慢生活(3)</a></li>
</ul>
<h2><p>近期文章</p></h2>
<ul class="news">
  <li><a href="%root_path%">女孩都有浪漫的小情怀</a></li>
</ul>
<h2><p>文章归档</p></h2>
<ul class="news">
  <li><a href="%root_path%">2008 年三月</a></li>
...
!function(){
  ...
  for (var i=0; i<pres.length; i++) {
      pres[i].className = "prettyprint linenums:2";
  };
...
<script src="http://localhost:8000/loader/run_prettify.js"></script>
